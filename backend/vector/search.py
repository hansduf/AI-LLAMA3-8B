...
class VectorSearchService:
    ...
    def __init__(self):
        self.embedding_dim = 384  # all-MiniLM-L6-v2 actual dimension (matches database)
        self.similarity_threshold = 0.5  # Higher threshold for better precision (was 0.3)
        self.max_results_default = 3  # Reduce to top 3 most relevant (was 10)
